...
$UtrustningListPath = "N:\QC\QC-1\IPT\Skiftspecifika dokument\PQC analyst\JESPER\Scripts\Click Less v06.9\Utrustninglista5.0.xlsx"
$RawDataPath        = "N:\QC\QC-1\IPT\KONTROLLPROVSFIL - Version 2.5.xlsm"
$SlangAssayPath     = (
    @('N:\\QC\\QC-1\\IPT\\Skiftspecifika dokument\\PQC analyst\\JESPER\\Scripts\\Click Less v06.9\\slangassay.xlsx',
      (Join-Path $ScriptRoot 'Click Less v06.9\\slangassay.xlsx'),
...
$Config = [ordered]@{
    ...
    SharePointEnabled = $true    # Tillåt SharePoint-anslutning/PnP.PowerShell
    SharePointInstallMissing = $true # Installera PnP.PowerShell automatiskt vid behov
