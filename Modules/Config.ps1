...
$UtrustningListPath = "N:\QC\QC-1\IPT\Skiftspecifika dokument\PQC analyst\JESPER\Scripts\Click Less Project v06\Utrustninglista5.0.xlsx"
$RawDataPath        = "N:\QC\QC-1\IPT\KONTROLLPROVSFIL - Version 2.5.xlsm"
$SlangAssayPath     = (
    @('N:\\QC\\QC-1\\IPT\\Skiftspecifika dokument\\PQC analyst\\JESPER\\Scripts\\Click Less Project v06\\Click Less Project\\slangassay.xlsx',
...
# ------------------------------------------------------------
# Performance toggles
# - FastMode: prefer predictable widths and fewer expensive operations
# - AutoFitColumns: EPPlus AutoFit is expensive on large ranges
# ------------------------------------------------------------
$Config.Performance = [ordered]@{
    FastMode                    = $true
...
# Writer caps to keep Information2 readable + fast
$Config.WriterInformation2 = [ordered]@{
    MaxFindings   = 50
    MaxErrorCodes = 60
    MaxAffected   = 250
}
