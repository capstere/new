...
function Write-Information2Sheet {
    ...
    try {
        ...
        if ($affEnd -ge $affStart) {
            ...
            # EPPlus 4.5.3.3: AddGreaterThan(range) + Formula = "<tal>"
            try {
                if ($ps.FailThreshold -ne $null) {
                    $cfMpFail = $Worksheet.ConditionalFormatting.AddGreaterThan("I$affStart:I$affEnd")
                    $cfMpFail.Formula = string
                ...
                if ($ps.WarnThreshold -ne $null) {
                    $cfMpWarn = $Worksheet.ConditionalFormatting.AddGreaterThan("I$affStart:I$affEnd")
                    $cfMpWarn.Formula = string
