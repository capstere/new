...
for ($i = 0; $i -lt $rowCount; $i++) {
    ...
    switch ($rawDev) {
        'ERROR' {
            ...
            # Endast felkoder som finns listade i regelbanken (numerisk kod) ska betraktas som Minor Functional.
            # Alla övriga (inklusive 'Other error codes' och okända koder) räknas som Instrument Error.
            ...
            # Minor om felkoden finns i listan eller är MTB indeterminate
            if ($known -or $isMtbInd) {
